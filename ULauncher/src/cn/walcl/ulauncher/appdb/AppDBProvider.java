package cn.walcl.ulauncher.appdb;

import java.util.List;

import cn.walcl.ulauncher.LauncherProvider.SqlArguments;
import cn.walcl.ulauncher.appdb.AppDB.AppInfos;
...
public class AppDBProvider extends ContentProvider {
	static final String AUTHORITY = "cn.walcl.ulauncher.appdb";
